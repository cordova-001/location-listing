                        ...
                        <form class="form inputs-underline" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-sm-9">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="listing-title" id="title" placeholder="Title">
                                        </div>
                                        <!--end form-group-->
                                    </div>
                                    <!--end col-md-9-->
                            ...
                            <section>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="video-url" id="video" placeholder="http://">
                                </div>
                                <!--end form-group-->
                            </section>
                            <section>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="facebook-uri" id="facebook" placeholder="http://">
                                        </div>
                                        <!--end form-group-->
                                        <div class="form-group">
                                            <label for="youtube">Youtube URL</label>
                                            <input type="text" class="form-control" name="facebook" id="youtube" placeholder="http://">
                                        </div>
                                        <!--end form-group-->
                                    </div>
                                    <!--end col-md-6-->
